...
async function notifySlack() {
    ...
    const parsedStartTime = new Date(startTime); // Parse startTime directly
    console.log('Parsed startTime:', parsedStartTime); // Log the result of parsing

    const isValidDate = parsedStartTime instanceof Date && !isNaN(parsedStartTime.valueOf());

    const formattedStartTime = isValidDate
        ? parsedStartTime.toLocaleTimeString('en-GB', {
